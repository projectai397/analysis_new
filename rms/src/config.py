...
class Settings:
    ...
    POSITIONS_COLL_ACTUAL = os.getenv("POSITION_COLL", "trade")
    POSITIONS_COLL_ACTUAL_1 = os.getenv("POSITION_COLL_ACTUAL", "position")
    SYMBOL_COLL = os.getenv("SYMBOL_COLL", "symbol")
...
open_positions = src_db[config.POSITIONS_COLL_ACTUAL_1]
symbols = src_db[config.SYMBOL_COLL]
